...
public class SimonSaysClient {
	 ...
	 */
	public SimonSaysClient(String serverIP, int serverPort, boolean connect, String logFileName) {
		...
		try {
			...
			cmdExec = new CmdExec(InetAddress.getByName(serverIP), serverPort, flogger);
	...
	public static void main(String[] args) {
		...
		new SimonSaysClient(serverIP, serverPort, connect, logfileName);
	}
}
