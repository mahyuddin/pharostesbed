 ...
 *
 * $Id: FiducialInterface.java 125 2011-03-24 02:24:05Z corot $
 *
 */
...
import playerclient3.structures.fiducial.PlayerFiducialData;
import playerclient3.structures.fiducial.PlayerFiducialFov;
import playerclient3.structures.fiducial.PlayerFiducialGeom;
import playerclient3.structures.fiducial.PlayerFiducialItem;
        ...
        try {
            switch (header.getSubtype ()) {
                case PLAYER_FIDUCIAL_DATA_SCAN: {
                    ...
                    // Buffer for reading fiducials (48 + 48 + 48 = 100 each)
                    // 4 bytes - ID
                    // 2 PlayerPose3d objects, 6 double fields
