...
public class RSSIBasedCBL {
	 ...
	 * The constructor.
	 */
	public RSSIBasedCBL(GroundTruth groundTruth, FileLogger outFlogger, FileLogger flogger) {
		...
		for (int t = 0; t <  nTimesteps; t++) {
            for (int i = 0; i < nRobots - 1; i++) {
                for (int j = i + 1; j < nRobots; j++) {
                    ...
                    // Scenario 3.1: use actual location instead of RSSI-based location
...
//	}
	...
	public static void main(String[] args) {
		...
		new RSSIBasedCBL(groundTruth, outFlogger, flogger);
	}
}
