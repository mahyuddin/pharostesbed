...
public abstract class Controller {
    ...
    protected double goal;// modified by liang
    
    /** the sum of all errors so far */
    protected float eSum;
    
    /** current error */
    protected double currE;// modified by liang
    /** last error */
    protected double lastE;// modified by liang

    /**
     * Set a new goal for the controller.
     * @param newGoal the new goal for the controller
     */
    public void setGoal (double newGoal) {// modified by liang
        this.goal = newGoal;
    }
