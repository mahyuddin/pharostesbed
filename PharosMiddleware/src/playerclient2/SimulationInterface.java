...
import playerclient2.structures.simulation.PlayerSimulationData;
import playerclient2.structures.simulation.PlayerSimulationPose2dReq;
...
public class SimulationInterface extends PlayerDevice {
    ...
    public void set2DPose (String identifier, PlayerPose pp) {
        ...
        try {
        	...
        	xdr.beginEncoding (null, 0);
        	xdr.xdrEncodeDouble (pp.getPx ());// modified by liang
        	xdr.xdrEncodeDouble (pp.getPy ());// modified by liang
        	xdr.xdrEncodeDouble (pp.getPa ());// modified by liang
        	xdr.endEncoding ();
        	os.write (xdr.getXdrData (), 0, xdr.getXdrLength ());
        	xdr.close ();
        	os.flush ();
