 ...
 *
 */
package playerclient2.structures;
...
public interface PlayerConstants {
    ...
    // the request subtypes (see player_interfaces.h)
    ...
    public final short PLAYER_PLAYER_REQ_DATAFREQ    = 6; // not used?
    public final short PLAYER_PLAYER_REQ_AUTH        = 7;
    public final short PLAYER_PLAYER_REQ_NAMESERVICE = 8;
    public final short PLAYER_PLAYER_REQ_IDENT       = 9; // not used?
