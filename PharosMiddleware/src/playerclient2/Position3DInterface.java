...
import playerclient2.structures.PlayerBbox3d;
import playerclient2.structures.PlayerMsgHdr;
import playerclient2.structures.PlayerPose3d;
import playerclient2.structures.position3d.PlayerPosition3dData;
import playerclient2.structures.position3d.PlayerPosition3dGeom;
  ...
  /**
    ...
    public void setPosition (PlayerPose3d pos, int state) {
        try {
        	...
        	xdr.xdrEncodeDouble (pos.getPy     ());  // modified by liang
        	xdr.xdrEncodeDouble (pos.getPz     ());  // modified by liang
        	xdr.xdrEncodeDouble (pos.getProll  ());  // modified by liang
        	xdr.xdrEncodeDouble (pos.getPpitch ());  // modified by liang
        	xdr.xdrEncodeDouble (pos.getPyaw   ());  // modified by liang
    ...
    public void setOdometry (PlayerPose3d pose) { 
        try {
        	...
        	xdr.beginEncoding (null, 0);
        	xdr.xdrEncodeDouble (pose.getPx     ()); // modified by liang
        	xdr.xdrEncodeDouble (pose.getPy     ()); // modified by liang
        	xdr.xdrEncodeDouble (pose.getPz     ()); // modified by liang
        	xdr.xdrEncodeDouble (pose.getProll  ()); // modified by liang
        	xdr.xdrEncodeDouble (pose.getPpitch ()); // modified by liang
        	xdr.xdrEncodeDouble (pose.getPyaw   ()); // modified by liang
        	xdr.endEncoding ();
        	os.write (xdr.getXdrData (), 0, xdr.getXdrLength ());
        	xdr.close ();
        	os.flush ();
    ...
    public double getX      () { // modified by liang
    	return this.pp3ddata.getPos ().getPx ();
    }
    
    public double getY      () {// modified by liang
    	return this.pp3ddata.getPos ().getPy ();
    }
    
    public double getYaw    () {// modified by liang
    	return (this.pp3ddata.getPos ().getPyaw () * 180) / Math.PI;
    }
