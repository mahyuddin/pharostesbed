...
/**
 * This runs on the CPSClient and provides the API for 
 * controlling the robot's movements and assertion requests/responses.
 * 
...
//	public static BeaconDataCollector bdc = new BeaconDataCollector("beaconData.txt");
	...
	public boolean sendMsg(AckableMessage msg) {
		...
		// no need to wait for an acknowledgement when sending an AssertionRequestMsg
	...
	public void newMessage(Message msg) {
		synchronized(this) {
			...
			if (rcvMsg instanceof AssertionResponseMsg) {
