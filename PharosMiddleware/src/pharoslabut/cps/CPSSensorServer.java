...
public class CPSSensorServer implements CricketDataListener, RangerListener, Position2DListener{


	public CPSSensorServer (
	...
	public void AssertCricket(Double actual, Inequality operation, Double delta) {

	}
	
	public void AssertCompass(Double actual, Inequality operation, Double delta) {
		
	}
	
	public void AssertOdometry(Double actualX, Double actualY, Inequality operation, Double deltaX, Double deltaY) {
		
	}
	
	public void AssertRange(Double actualRange, Inequality operation, Double delta) {
