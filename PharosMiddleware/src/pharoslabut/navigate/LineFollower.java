...
//	/**
//	 * Notifies the blob data consumers of the new blob data.
//	 * 
//	 * @param blobData The new blob data.
//	 */
//	private void notifyBlobDataConsumers(final PlayerBlobfinderData blobData) {
//		
//		// Notify the consumers using a separate thread.
